	...
	global.fetch = (url) => {
		...
		if (url.includes('solr')) {
			json = {
					...
					docs: [
						{
							...
							year: ['2021'],
							path: ['ndtceda21/Northwestern/HaPa'],
							download_path: ['ndtceda21/Northwestern/HaPa/test.docx'],
						},
						{
							type: ['cite'],
				...
				highlighting: {
					'ndtceda21/Northwestern/HaPa/test.docx': {
