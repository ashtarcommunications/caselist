...
const fixLDNames = async () => {
    ...
    for (const t of teams) {
        console.log(`Fixing team ${t.team_id} for ${t.caselist_name}/${t.school_name}/${t.team_name}...`);
        ...
        await limiter.schedule(async () => {
            ...
            console.log(`Changing ${t.team_name} to ${name} for ${t.debater1_first} ${t.debater1_last}...`);
            try {
                await query(SQL`
