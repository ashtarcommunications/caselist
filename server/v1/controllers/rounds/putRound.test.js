...
describe('PUT /v1/caselists/{caselist}/schools/{school}/teams/{team}/rounds/{round}', () => {
    beforeEach(async () => {
        ...
        await fs.promises.mkdir(`${config.UPLOAD_DIR}/testcaselist/testschool/testteam`, { recursive: true });
        await fs.promises.writeFile(`${config.UPLOAD_DIR}/testcaselist/testschool/testteam/testschool-testteam-Aff-Test-Update-Round-Round-1.docx`, 'test');
    });
    ...
    it('should update a round', async () => {
        ...
        assert.strictEqual(updatedRound[0].opensource, 'testcaselist/testschool/testteam/testschool-testteam-Neg-Test-Update-Round-Round-2.docx', 'Open Source updated');
        ...
        try {
            await fs.promises.access(`${config.UPLOAD_DIR}/testcaselist/testschool/testteam/testschool-testteam-Neg-Test-Update-Round-Round-2.docx`, fs.constants.F_OK);
        } catch (err) {
    ...
    it('should remove an open source file when updating a round', async () => {
        ...
        try {
            await fs.promises.access(`${config.UPLOAD_DIR}/testcaselist/testschool/testteam/testschool-testteam-Aff-Test-Update-Round-Round-1.docx`, fs.constants.F_OK);
        } catch (err) {
            assert.isOk(err, 'File deleted');
        }

        try {
            await fs.promises.access(`${config.UPLOAD_DIR}/testcaselist/testschool/testteam/testschool-testteam-Aff-Test-Update-Round-Round-1-DELETED-v1.docx`, fs.constants.F_OK);
        } catch (err) {
            assert.isNotOk(err, 'File renamed');
        }
    });
    ...
    afterEach(async () => {
        try {
            ...
            await fs.promises.rm(`${config.UPLOAD_DIR}/testcaselist/testschool/testteam/testschool-testteam-Aff-Test-Update-Round-Round-1.docx`);
            await fs.promises.rm(`${config.UPLOAD_DIR}/testcaselist/testschool/testteam/testschool-testteam-Neg-Test-Update-Round-Round-2.docx`);
        } catch (err) {
            // Do Nothing
        }
    });
