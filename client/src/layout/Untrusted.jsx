...
const Untrusted = () => {
    ...
    message += 'If you think this determination is in error, try logging out and back in. If your ';
    message += 'account is brand new, try waiting a few days and then log in again. ';
