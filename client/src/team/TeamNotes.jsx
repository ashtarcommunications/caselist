	...
	return (
		<div className={`${styles.notes} ${isMobile && styles.mobile}`}>
			<form onSubmit={handleSubmit(updateNotesHandler)} className="pure-form">
				...
				<br />
				{showNotes && <textarea id="team-notes" {...register('notes')} />}

				{isDirty && (
					<p className={styles.warning}>
						Remember, this information is public - if sharing contact info,
						consider using a dedicated email address instead of a personal email
					</p>
				)}
