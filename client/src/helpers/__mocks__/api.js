...
export const loadDownloads = jest.fn().mockResolvedValue([
    { name: 'testcaselist-all.zip', path: '/weekly/test/testcaselist-all.zip' },
    { name: 'testcaselist-weekly.zip', path: '/weekly/test/testcaselist-weekly.zip' },
]);
...
export const loadTeams = jest.fn().mockResolvedValue([{ team_id: 1, name: 'testteam', display_name: 'Test Team', debater1_first: 'Aaron', debater1_last: 'Hardy', updated_by: 'Test User' }]);
...
export const loadTeam = jest.fn().mockResolvedValue({ team_id: 1, name: 'testteam', display_name: 'Test Team', debater1_first: 'Aaron', debater1_last: 'Hardy', updated_by: 'Test User' });
...
export const loadCites = jest.fn().mockResolvedValue([{ cite_id: 1, round_id: 1, title: 'Title', cites: 'Test Cites' }]);
