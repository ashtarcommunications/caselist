...
const CaselistHome = () => {
	...
	return (
		<div className={styles['caselist-home']}>
			...
			<div>
				<p>
					This site provides a space for collaborative intel for the debate
					community.
				</p>
				...
				<p>
					...
					syntax, such as that produced automatically in Verbatim. If you are
					pasting directly from Word, it will be unformatted text.
				</p>
