...
-- Mon 05 Jul 2021 07:58:56 PM MDT
...
-- -----------------------------------------------------
-- Table `caselist`.`wikis`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `caselist`.`wikis` (
...
CREATE TABLE IF NOT EXISTS `caselist`.`schools` (
  ...
  INDEX `school_fk_wiki_idx` (`wiki_id` ASC) VISIBLE,
  CONSTRAINT `school_fk_wiki`
    FOREIGN KEY (`wiki_id`)
    REFERENCES `caselist`.`wikis` (`wiki_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION);
